...
Outputs: Validated DetectedObject and PlayerDetectionResult domain models
"""
...
class DetectedObject(BaseModel):
    ...
    class_id: int = Field(..., description="YOLO COCO class ID")
...
class PlayerDetectionResult(BaseModel):
    """Aggregated detection result for a single video frame."""
    frame_number: int
